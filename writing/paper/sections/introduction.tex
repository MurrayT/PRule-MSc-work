...
avoiding a classical pattern of length 3 by computational methods, which are then
used to establish three ``Dominating Pattern Rules'' as well as some special cases
that can be used to calculate coincidences. We then use these coincidence classes
