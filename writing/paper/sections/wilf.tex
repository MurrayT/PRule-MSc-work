...
Computing avoiders up to length 10 suggests that there are at least 23 \(\weqv{231}\)-equivalence classes,
...
the same enumeration and are therefore \(m_3\weqv{m_4}\).
