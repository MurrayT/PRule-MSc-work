...
\textcite{DBLP:journals/corr/ClaessonTU14}.
 \begin{example}
   ...
   \end{equation*}
	does not follow from the general methods presented by \textcite{DBLP:journals/corr/ClaessonTU14}, but is rather handled there as
	a special case. We can do it as follows:
