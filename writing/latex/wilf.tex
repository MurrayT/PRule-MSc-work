...
Wilf-classes, of which \(13\) are non-trivial, this means that there are
Wilf-equivalences between patterns that are not explained by coincidences.
...
The idea of the bijection is as follows.
...
\end{equation*}
Consider containers of these patterns in \(\av{\perm{2,3,1}}\).
