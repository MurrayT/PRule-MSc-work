...
\end{equation*}
Let \(\scriptvar_1\) be the set of avoiders of \(m_1\), by structural decomposition
...
\begin{equation*}
    \scriptvar_2 = \varepsilon \sqcup
    \decompleft{0/1,1/0}{\scriptvar_2}{}{}{\scriptvar^\prime_2}
\end{equation*}

Again we use the same method of decomposition of a permutation in \(\scriptvar^\prime_2\)
\begin{equation*}
    \scriptvar^\prime_2 = \varepsilon \sqcup
    \decompleft{0/1,1/0}{\scriptstyle \scriptvar_2\setminus\varepsilon}{}{}{\scriptvar^\prime_2}
\end{equation*}
