...
\nextvar
The pattern \(p_1 = \textpattern{}{1}{0/1,1/0}\) is one of the
...
shading in \(p_1\). The lower left region however can create occurrences
...
Considering an occurrence of either of these patterns in a permutation by
