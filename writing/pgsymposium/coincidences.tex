...
\hline
\multicolumn{1}{|r|}{Starting Size of Classes}&\(512\)&\(512\)&\(512\)&\(512\)\\
\hline
\multicolumn{1}{|r|}{Removing Symmetries}&\(220\)&\(220\)&\(220\)&\(220\)\\
\hline
...
\begin{frame}
  \begin{example}[Graphical interpretation of one case of The Second Dominating rule]
    \begin{figure}[ht]
\centering
\begin{tikzpicture}[scale = 0.75]
     ...
     \fill[black!25] (3.25,2.75) circle (0.05);
     \fill[black!25] (3.5,2.5) circle (0.05);
     \fill[black!25] (3.75,2.25) circle (0.05);
...
\end{frame}
\begin{frame}
  \begin{example}[\(m_1 = \textpattern{}{1,2}{0/1,0/2,2/0,2/1} \text{ and } m_2 = \textpattern{}{1,2}{0/1,0/2,1/1,2/0,2/1}\) are coincident in \(\av{\perm{2,3,1}}\).]
    \begin{description}
